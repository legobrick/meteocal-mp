...
Once that a user logs in to the system trough a defined web page he is redirected to the main page. This page is divided in two portion. The left one displays a monthly calendar in which the user manage its events while the right one shows the weather forecast for the following five day and also shows the closet events to the current day.
